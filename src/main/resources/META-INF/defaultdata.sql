...
insert into PatientEntity (patient_id, first_name, last_name, gender, age, email, address_line1, address_line2, city, state, country, zip_code, last_appointment, upcoming_appointment) values (1003, 'Tony','Stark','MALE',58,'tony@stark.com','addressLine1','addressLine2','city','state','country','zip_code','2021-11-30T00:00:00Z','2023-03-06T00:00:00Z');
